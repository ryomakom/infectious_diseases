...
# OGP画像のキャッシュバスト: index.html の ?v= パラメータを基準日で更新する。
# SNS各社はURLが変わらない限り古い画像をキャッシュし続けるため、
# データ更新のたびに ?v=YYYYMMDD を書き換えて新規フェッチを促す。
tryCatch({
  ...
  message("OGP ?v= を ", v_str, " に更新しました")
}, error = function(e) message("index.html の ?v= 更新に失敗: ", conditionMessage(e)))
